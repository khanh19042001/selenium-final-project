...
import com.misa.helpers.CaptureHelpers;
import com.misa.helpers.PropertiesHelpers;
import com.misa.report.ExtentReportManager;
import com.misa.report.ExtentTestManager;
...
import static com.misa.constants.FrameworkConst.*;
...
public class WebUI {
    ...
    public static By getByXpathDynamic(String locatorForm, Object... keyValue) {
    ...
    public void clickElement(Object object, String... titles) {
        waitForElementClickable(object);
    ...
    public static void assertFalseCondition(Object object, boolean isResult, FailureHandling failureHandling, String errMsg) {
        ...
        } else if (Objects.nonNull(errMsg) && errMsg.contains(SEPARATE_KEY)) {
